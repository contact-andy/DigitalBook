...
<div class="container-fluid p-0">
    ...
    <div class="row" style="margin-top: -30px">
        <div class="col-12">
                    ...
                    <table id="datatables-fixed-header" class="table table-striped w-100">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select class="form-control" id="contentOk{{$template->id}}" name="contentOk{{$template->id}}">
                                        <option value="true">Yes</option>
                                        <option value="false">No</option>
                                    </select>
                                </td>
                                <td>
                                    <select class="form-control" id="grammerOk{{$template->id}}" name="grammerOk{{$template->id}}">
                                        <option value="true">Yes</option>
                                        <option value="false">No</option>
                                    </select>
                                </td>
                                <td>
                                    <select class="form-control" id="spellingOk{{$template->id}}" name="spellingOk{{$template->id}}">
                                        <option value="true">Yes</option>
                                        <option value="false">No</option>
                                    </select>
                                </td>
                                ...
                                <td>
                                    <input type="text" class="form-control" id="comment{{ $template->id }}" name="comment{{ $template->id }}" value="{{ $template->name }}" />
                                </td>
                                <td>
                                    ...
                                    <button type="button" id="save{{ $template->id }}" title="Reject" class="btn btn-sm" onclick="saveApproval({{ $template->id }}, 0)">
                                        <i class="align-middle" data-lucide="save" style="color: #D9534F;width: 20px;height: 20px;"></i>
                                    </button>
                                </td>
                            </tr>
                            @endforeach
            ...
            <script>
                function saveApproval(categoryId, status) {
