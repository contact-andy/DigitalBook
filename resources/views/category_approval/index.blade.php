        ...
        <div class="col-12">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td id="statusView{{ $category->id }}">
                                    ...
                                    @endif
                                    <div id="spinnerView{{ $category->id }}" style="display:none;">
                                        {{-- <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200"><circle fill="#6D6DFF" stroke="#6D6DFF" stroke-width="2" r="15" cx="40" cy="100"><animate attributeName="opacity" calcMode="spline" dur="2" values="1;0;1;" keySplines=".5 0 .5 1;.5 0 .5 1" repeatCount="indefinite" begin="-.4"></animate></circle><circle fill="#6D6DFF" stroke="#6D6DFF" stroke-width="2" r="15" cx="100" cy="100"><animate attributeName="opacity" calcMode="spline" dur="2" values="1;0;1;" keySplines=".5 0 .5 1;.5 0 .5 1" repeatCount="indefinite" begin="-.2"></animate></circle><circle fill="#6D6DFF" stroke="#6D6DFF" stroke-width="2" r="15" cx="160" cy="100"><animate attributeName="opacity" calcMode="spline" dur="2" values="1;0;1;" keySplines=".5 0 .5 1;.5 0 .5 1" repeatCount="indefinite" begin="0"></animate></circle></svg> --}}
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200" style="display:block">
                                        <circle fill="#1D24FF" stroke="#1D24FF" stroke-width="1" r="5" cx="40" cy="100"><animate attributeName="opacity" calcMode="spline" dur="2" values="1;0;1;" keySplines=".5 0 .5 1;.5 0 .5 1" repeatCount="indefinite" begin="-.4"></animate>
                                        </circle>
                                        <circle fill="#1D24FF" stroke="#1D24FF" stroke-width="1" r="5" cx="70" cy="100"><animate attributeName="opacity" calcMode="spline" dur="2" values="1;0;1;" keySplines=".5 0 .5 1;.5 0 .5 1" repeatCount="indefinite" begin="-.2"></animate>
                                        </circle>
                                        <circle fill="#1D24FF" stroke="#1D24FF" stroke-width="1" r="5" cx="100" cy="100"><animate attributeName="opacity" calcMode="spline" dur="2" values="1;0;1;" keySplines=".5 0 .5 1;.5 0 .5 1" repeatCount="indefinite" begin="0"></animate>
                                        </circle>
                                    </svg>
                                    </div>
            ...
            <script>
                function approveRejectInstant(categoryId, status) {
                    ...
                    // alert(categoryId)
                    // document.getElementById("spinnerView"+categoryId).style.display = "block";
                    $("#spinnerView"+categoryId).show();
                    $.ajax({
                        ...
                        success: function(response) {
                            if(response.success) {
                                ...
                                // document.getElementById("spinnerView"+categoryId).style.display = "none";
                                $("#spinnerView"+categoryId).hide();
                                if(status){
